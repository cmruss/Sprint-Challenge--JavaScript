...
const ULuniversities = graduates.map(function(value) {
...
let animaNames = zooAnimals.map(function(value) {
  return (value.animal_name);
});
const lowCaseAnimalNames = animaNames.map(function lowCase(item) {
